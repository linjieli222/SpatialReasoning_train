#!/bin/bash
# td_path answer-only v2 (fixed data with instrs[1] question+choices)
# 9,689 samples, ~32 samples/step, 5 epochs -> ~1,515 steps (use 1,563)

resume_from=${resume_from:-"/gpfs/scrubbed/linjli/hf_cache/BAGEL-7B-MoT"}
run_name=${run_name:-"ao_td_path_8gpu"}
