...
output_path=${output_path:-"/gpfs/scrubbed/krishna/linjli/bagel_debug_output/tifa_v3_td_ego_dir_mmcot/${run_name}/output"}
ckpt_path=${ckpt_path:-"/gpfs/scrubbed/krishna/linjli/bagel_debug_output/tifa_v3_td_ego_dir_mmcot/${run_name}"}
...
torchrun \
  ...
  --dataset_config_file ./data/configs/tifa_v3_td_ego_dir_mmcot.yaml \
