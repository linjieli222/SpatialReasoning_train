#!/bin/bash
# td_path CoT latent 64 (v2: fixed data with instrs[1] question+choices)
# 9,689 samples, ~8 samples/step, 5 epochs -> ~6,056 steps (use 6,250)
